    ...
    <div class="dashboard-container">
      ...
      <main class="dashboard-main">
        <div class="welcome-section">
          ...
          <p>Bạn đang truy cập với quyền nhân viên thư viện</p>
        </div>
        ...
        <div class="features-grid">
          <div class="feature-card">
            ...
            <h3>Quản lý sách</h3>
            <p>Thêm, sửa, xóa thông tin sách</p>
          </div>
          <div class="feature-card">
            <i class="fas fa-hand-holding"></i>
            <h3>Cho mượn sách</h3>
            <p>Xử lý yêu cầu mượn sách của sinh viên</p>
          </div>
          <div class="feature-card">
            <i class="fas fa-undo"></i>
            <h3>Thu hồi sách</h3>
            <p>Xử lý việc trả sách</p>
          </div>
          <div class="feature-card">
          ...
          <div class="feature-card">
            ...
            <h3>Báo cáo</h3>
            <p>Thống kê mượn trả sách</p>
          </div>
          <div class="feature-card">
            <i class="fas fa-exclamation-triangle"></i>
            <h3>Sách quá hạn</h3>
            <p>Danh sách sách quá hạn trả</p>
          </div>
        </div>
      </main>
    </div>
